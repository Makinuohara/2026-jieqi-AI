...
- 当前共有 67 项自动化测试，覆盖模型、规则、AI、协议、服务器和本地人机对局，
  可以通过 `.\mvnw.cmd test` 运行。

## 需要完善

当前已经可以完成本地真人对随机 AI 的揭棋对局，其他模式仍在继续开发。主要缺少：

- 完整贪心评估和 Expectiminimax 概率搜索，该功能正在开发。
- 本地 AI 对 AI 的完整自动对局循环、暂停、单步和速度调整，该功能正在开发。
...
当前可运行本地真人对随机 AI；AI 对 AI 正在开发，后续重点是完善 AI 搜索和联网对局。
